...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-4622072174')
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-4689726972').split()]  # For Multiple Id Use One Space Between Each.
