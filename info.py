...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002606772683').split()]  # For Multiple Id Use One Space Between Each.
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002347095058')
...
# Links
GRP_LNK = environ.get('GRP_LNK', https://t.me/+dejBWOJMXXs0OGVl'https://t.me/vj_bot_disscussion')
