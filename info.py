...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002513188868').split()]  # For Multiple Id Use One Space Between Each.
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002606772683').split()]  # For Multiple Id Use One Space Between Each.
...
O_DB_URI = environ.get('O_DB_URI', "https://t.me/+dejBWOJMXXs0OGVl")   # This Db Is For Other Data Store
F_DB_URI = environ.get('F_DB_URI', "https://t.me/+X2I1yg-OXK8wMWY1")   # This Db Is For File Data Store
S_DB_URI = environ.get('S_DB_URI', "https://t.me/+UxKRKuVeJlswYzBl")   # This Db is for File Data Store When First Db Is Going To Be Full.
